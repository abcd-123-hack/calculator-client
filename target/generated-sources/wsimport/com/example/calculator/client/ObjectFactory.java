 ...
 * generated in the com.example.calculator.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Div_QNAME = new QName("http://calculator.example.com/", "div");
    private final static QName _DivResponse_QNAME = new QName("http://calculator.example.com/", "divResponse");
    private final static QName _Mul_QNAME = new QName("http://calculator.example.com/", "mul");
    private final static QName _MulResponse_QNAME = new QName("http://calculator.example.com/", "mulResponse");
    private final static QName _Sub_QNAME = new QName("http://calculator.example.com/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://calculator.example.com/", "subResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.example.calculator.client
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://calculator.example.com/", name = "div")
     ...
     */
    @XmlElementDecl(namespace = "http://calculator.example.com/", name = "divResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://calculator.example.com/", name = "mul")
     ...
     */
    @XmlElementDecl(namespace = "http://calculator.example.com/", name = "mulResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://calculator.example.com/", name = "sub")
     ...
     */
    @XmlElementDecl(namespace = "http://calculator.example.com/", name = "subResponse")
